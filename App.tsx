  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'login') {
        ...
        // NOTE: Profile creation is now handled by a Database Trigger (on_auth_user_created)
        // This prevents RLS errors when email verification is pending (since the client doesn't have a session yet)
        
        setSuccessMessage("Account created! Please check your email to verify (if enabled) or log in.");
